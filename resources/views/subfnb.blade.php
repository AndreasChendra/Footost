        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col" style="border-radius: 20px">
                ...
                <div class="card text-white mt-4 mb-4">
                    <img src="{{asset('images/cafe.jpg')}}" class="card-img-top" height="350" style="border-radius: 20px">
            ...
            <div class="col" style="border-radius: 20px">
                <a href="#">
                <div class="card text-white mt-4 mb-4">
                    <img src="{{asset('images/makanan-berat.jpg')}}" class="card-img-top" height="350" style="border-radius: 20px">
                    <div class="card-img-overlay">
