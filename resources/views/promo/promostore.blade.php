...
@section('content')
    <div class="container">
        ...
        <div>
            <h1 class="text-center mt-4">Promo</h1>
        </div>
        <div class="row">
            <div class="col">
                ...
                <a href="" class="btn btn-success d-flex justify-content-center">Add Promo</a>
            </div>
                ...
                {{-- @foreach ($collection as $item) --}}
                    <div class="card mb-3" style="max-width: 100%;">
                        <div class="card-body">
                            <div class="row g-5">
                                <div class="col-md-4">
                                    <img src="{{asset('images/starbucks.jpg')}}" width="200" height="150" alt="...">
                                </div>
                            ...
                            <div class="d-grid mt-3">
                                ...
                                <a href="" class="btn btn-danger">Delete Promo</a>
                            </div>
                        </div>
                    </div>
                {{-- @endforeach --}}
