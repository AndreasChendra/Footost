...
@section('content')
    <div class="container mt-4">
        ...
        <div class="col">
            <img src="{{asset('images/kos1.jpg')}}" width="100%" height="500">
        </div>
        <div class="col">
            <div class="row row-cols-2">
                <div class="col"><h3>Kost Square VIP Residence</h3></div>
            ...
            <div>
                ...
                <p class="card-text">Fasilitas : -kamar mandi dalam -akses 24 jam -wifi</p>
            </div>
            <div class="mt-3">
                <p>
